...
background-image: url('http://localhost:8085/project_0/resources/img/in.png');
...
background-image: url('http://localhost:8085/project_0/resources/img/gb3.png');
...
<nav class="navbar navbar-expand-lg navbar-dark imc3">

<div class="container-fluid">
	<a class="navbar-brand" href='<c:url value="/Welcome"></c:url>'><img
		class="im1"
		src='<c:url value="http://localhost:8085/project_0/resources/img/custom1.png"></c:url>'></a>
 ...
 --%>
	...
	<div class="dropdown">
		<button class="btn-warning btn-secondary dropdown-toggle"
			type="button" id="dropdownMenuButton" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false">
			<s:message code="label.lang" />
		</button>
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">

			<li class="nav-item dropdown"><a
				class="text-dark bg-info circle p-1 m-0 dropdown-item"
				href='<c:url value="?lang=en" ></c:url>'><i class="flagen"></i><strong>English</strong></a><br>
				<a class="text-dark bg-danger circle p-1 m-0 dropdown-item"
				href="<c:url value="?lang=hi"></c:url>"><i class="flagin"></i><strong>हिन्दी</strong></a></li>
		</div>
	</div>
