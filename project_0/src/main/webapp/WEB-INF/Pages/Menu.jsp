...
<div id="main">
  <button class="openbtn" onclick="openNav()"  style="background-image:url('<c:url value="http://localhost:8085/Project0/resources/img/11.jpg"></c:url>'); "><i class="fa fa-list"></i> Menu </button>  
