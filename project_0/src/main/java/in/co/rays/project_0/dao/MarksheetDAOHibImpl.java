...
public class MarksheetDAOHibImpl implements MarksheetDAOInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#add(in.co.rays.project_0.dto.MarksheetDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#update(in.co.rays.project_0.dto.MarksheetDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#findByRollNo(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#search(in.co.rays.project_0.dto.MarksheetDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.project_0.dao.MarksheetDAOInt#getMeritList(int, int)
	 */
