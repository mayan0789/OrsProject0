...
import in.co.rays.project_0.form.ChangePasswordForm;
import in.co.rays.project_0.form.MyProfileForm;
import in.co.rays.project_0.form.UserForm;
	...
	public String submit(@RequestParam(required = false) Long id, @ModelAttribute("form") @Valid UserForm form,
		...
		if (OP_SAVE.equalsIgnoreCase(form.getOperation())||OP_UPDATE.equalsIgnoreCase(form.getOperation())) {
			...
			if(!dto.getPassword().equals(dto.getConfirmPassword())){
				String conPwdMatch = messagesource.getMessage("pattern.matchpass", null, locale);
