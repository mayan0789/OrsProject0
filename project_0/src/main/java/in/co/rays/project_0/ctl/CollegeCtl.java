...
import in.co.rays.project_0.form.CollegeForm;
import in.co.rays.project_0.service.CollegeServiceInt;
...
public class CollegeCtl extends BaseCtl {
	...
	public String submit(@RequestParam(required = false) String operation, @ModelAttribute("form") CollegeForm form,
		...
		if (OP_PREVIOUS.equalsIgnoreCase(operation)) {
			pageNo--;
			System.out.println("page No  previous POST--->" + pageNo);
		}
		if (OP_NEXT.equalsIgnoreCase(operation)) {
			pageNo++;
			System.out.println("page No next POST--->" + pageNo);
		}
